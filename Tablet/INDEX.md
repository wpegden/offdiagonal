...
| F2ForwardIndependentNearDiagonalBound | lemma | proof | closed | - | - | F2ForwardIndependentTuples, F2NearDiagonalExponentIdentity, F2NearDiagonalLargeSPowerBound, F2NearDiagonalLogControlBundle, F2NearDiagonalQuadraticMaxBound, F2NearDiagonalSummandFromLogControls, F2NearDiagonalSummationAbsorptionBound |
...
| F2NearDiagonalLogControlBundle | helper | proof | closed | - | - | F2NearDiagonalBinomialLogBound, F2NearDiagonalLogSquareBound, F2NearDiagonalQuadraticMaxBound, F2NearDiagonalSmallXLogBound |
...
| StarProductAbsorbedTreeCountingBound | helper | proof | closed | - | - | StarProductConcreteTreeCountingBound, StarProductDeltaPowerLeQPower, StarProductFinalNumericalAbsorption, StarProductFloorWeightSideConditions, StarProductQPowerLeTwoPow |
| StarProductConcreteAllChildrenBound | helper | proof | closed | - | - | StarProductForwardIndependentChildCountLeVertices, StarProductPolarityVertexCountBound |
| StarProductConcreteMarked | definition | definition | closed | - | - | StarProductPoorChild, StarProductPopularChild |
| StarProductConcreteMarkedChildrenBound | helper | proof | closed | - | - | StarProductConcreteMarkedChildrenCertificate, StarProductPoorChildrenBound, StarProductPopularChildrenBound |
| StarProductConcreteMarkedChildrenCertificate | helper | proof | closed | - | - | ForwardIndependentTuple, StarProductConcreteMarked, StarProductDigraph, StarProductMarkedChildrenBound |
| StarProductConcretePathUnmarkedCertificate | helper | proof | closed | - | - | BinarySequenceWeight, StarProductConcreteMarked, StarProductMarkedTupleSignature, StarProductPathRankAtMostSize, StarProductPathUnmarkedBound |
| StarProductConcretePathWeightBound | helper | proof | closed | - | - | PolarityGraphParameters, StarProductConcretePathUnmarkedCertificate, StarProductConcreteUnmarkedPathNonempty, StarProductConcreteUnmarkedPathShrink, StarProductPathRankAtMostSizeMono, StarProductPolarityParameterBounds, StarProductShrinkCollapseForLaterExponents, StarProductShrinkThresholdCollapse |
| StarProductConcreteTreeCountingBound | helper | proof | closed | - | - | StarProductConcreteAllChildrenBound, StarProductConcreteMarkedChildrenBound, StarProductConcretePathWeightBound, StarProductHLeDelta, StarProductMarkedTreeCountingBridge, StarProductPolarityParameterBounds, StarProductWLeK |
| StarProductConcreteUnmarkedExtensionNonempty | lemma | proof | closed | - | - | StarProductLayerChoicePositive |
| StarProductConcreteUnmarkedExtensionShrink | lemma | proof | closed | - | - | StarProductConcreteMarked, StarProductForwardIndependentExtensionRankLe, StarProductLayerChoiceLe, StarProductRankAtMostCardLeSuccMulLayerChoice, StarProductRankAtMostSetSnocSubset, StarProductRankIncreasesOnGoodExtension, StarProductUnmarkedStepShrink |
| StarProductConcreteUnmarkedPathNonempty | lemma | proof | closed | - | - | StarProductConcreteMarked, StarProductConcreteUnmarkedExtensionNonempty, StarProductConcreteUnmarkedPsiApply, StarProductForwardIndependentExtensionRankLe, StarProductMarkedTupleSignature, StarProductPathRankAtMostSize |
| StarProductConcreteUnmarkedPathShrink | lemma | proof | closed | - | - | StarProductConcreteMarked, StarProductConcreteUnmarkedExtensionShrink, StarProductConcreteUnmarkedPsiApply, StarProductForwardIndependentExtensionRankLe, StarProductMarkedTupleSignature, StarProductPathRankAtMostSize |
| StarProductConcreteUnmarkedPsi | definition | definition | closed | - | - | StarProductLayerChoiceLe |
| StarProductConcreteUnmarkedPsiApply | lemma | proof | closed | - | - | StarProductConcreteUnmarkedPsi |
...
| StarProductFloorWeightSideConditions | helper | proof | closed | - | - | Preamble |
| StarProductForwardIndependentBound | lemma | proof | closed | - | - | ExpanderMixingLemma, ForwardIndependentTupleCount, ForwardIndependentTupleCountSuccSnoc, MarkedTreePathCounting, PolarityGraphParameters, ProductDigraphVertex, StarProductAbsorbedTreeCountingBound, StarProductConcreteAllChildrenBound, StarProductConcreteMarkedChildrenBound, StarProductConcreteMarkedChildrenCertificate, StarProductConcretePathUnmarkedCertificate, StarProductConcretePathWeightBound, StarProductConcreteTreeCountingBound, StarProductConcreteUnmarkedPathNonempty, StarProductConcreteUnmarkedPathShrink, StarProductConsistentTuple, StarProductDeltaPowerLeQPower, StarProductDigraph, StarProductExtensionOrthogonalToPrefixSpan, StarProductFinalNumericalAbsorption, StarProductFixedBExtensionBound, StarProductFixedBRankLeExtensionBound, StarProductFloorWeightSideConditions, StarProductForwardIndependentChildCountLeVertices, StarProductForwardIndependentConsistentTuple, StarProductFullRankNoForwardIndependentExtension, StarProductHLeDelta, StarProductLayerChoiceLe, StarProductLayerChoiceMax, StarProductLayerChoicePositive, StarProductLayerChoiceRealLowerBound, StarProductMarkedChildrenBound, StarProductMarkedTreeCountingBridge, StarProductParameterChoice, StarProductPathRankAtMostSizeMono, StarProductPathUnmarkedBound, StarProductPolarityVertexCountBound, StarProductPoorChildrenBound, StarProductPoorExpanderMixingBound, StarProductPopularChildrenBound, StarProductPopularDoubleCountingBound, StarProductQPowerLeTwoPow, StarProductShrinkCollapseForLaterExponents, StarProductShrinkThresholdCollapse, StarProductUnmarkedStepShrink, StarProductWLeK |
...
| StarProductForwardIndependentExtensionRankLe | lemma | proof | closed | - | - | StarProductFullRankNoForwardIndependentExtension |
...
| StarProductMarkedTupleFiberCount | definition | definition | closed | - | - | ForwardIndependentTuple, StarProductMarkedTupleSignature |
| StarProductMarkedTupleSignature | definition | definition | closed | - | - | StarProductDigraph |
| StarProductParameterChoice | helper | proof | closed | - | - | Preamble |
| StarProductPathRankAtMostSize | definition | definition | closed | - | - | StarProductRankAtMostSet |
| StarProductPathRankAtMostSizeMono | lemma | proof | closed | - | - | StarProductPathRankAtMostSize, StarProductRankAtMostSetSnocSubset |
...
| StarProductPoorRankChildrenBound | helper | proof | closed | - | - | ForwardIndependentTuple, StarProductDigraph, StarProductPoorChild, StarProductPoorRankEdgeBound |
| StarProductPoorRankEdgeBound | helper | proof | closed | - | - | ExpanderMixingLemma, PolarityGraphParameters, StarProductLayerChoiceMax, StarProductPolarityParameterBounds, StarProductPoorExpanderMixingBound |
