...
\end{lemma}
\begin{proof}
Suppose, for a contradiction, that vertices
\[
...
\(\noderef{StarProductDigraph}\), for every \(i\) we have
\[
...
represents a projective point.  Hence no such transitive tournament exists.
\end{proof}
